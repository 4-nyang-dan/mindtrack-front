  ...
  return (
    <>
      <div className="card auth-card">
        ...
        <p className="helper">
          아직 회원이 아니신가요?
          <button className="link" onClick={() => setOpenSignup(true)}> 회원가입</button>
        </p>
      </div>
...
function Main() {
  ...
  const MAX_W = 520;           // 내용 최대폭
  const TOPBAR_H = 64;         // 상단바 높이 대략값
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <button
            style={{ border: "none", background: "#f3f3f3", borderRadius: 8, padding: "6px 10px", cursor: "pointer" }}
          >
            ⚙️ 설정
          </button>
          <button
            style={{ border: "none", background: "#ffe5e5", color: "#e00", borderRadius: 8, padding: "6px 10px", cursor: "pointer" }}
        ...
        <section className="card" style={{ textAlign: "center" }}>
          <div style={{ display: "flex", justifyContent: "center", gap: 12 }}>
            <button
              ...
              style={{ background: "#e9f5ff", border: "none", borderRadius: 12, padding: "10px 20px", fontWeight: 600, cursor: "pointer", boxShadow: "0 2px 5px rgba(0,0,0,0.1)" }}
            >
              ▶ 실행
            </button>
            <button
              style={{ background: "#f2f2f2", border: "none", borderRadius: 12, padding: "10px 20px", fontWeight: 600, cursor: "pointer", boxShadow: "0 2px 5px rgba(0,0,0,0.1)" }}
            >
              ⟳ 업데이트
            </button>
            <button
              onClick={stopCapture}
              style={{ background: "#ffe5e5", border: "none", borderRadius: 12, padding: "10px 20px", fontWeight: 600, cursor: "pointer", color: "#e00", boxShadow: "0 2px 5px rgba(0,0,0,0.1)" }}
            >
              ■ 정지
            </button>
          </div>
            ...
            {(actions.length > 0 ? actions : Array(3).fill(null)).map((a, i) => (
              <div
                ...
                style={{
                  ...
                  fontSize: 14,
                  boxShadow: a
                    ? "inset 0 0 5px rgba(0, 100, 200, 0.1)"
